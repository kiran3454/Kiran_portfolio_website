    ...
    <main className="relative w-full overflow-x-hidden bg-black">
      {loading ? (
        ...
        <>
          ...
          <section id="about" className="min-h-screen bg-gray-950 py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            {/* Parallax background */}
                ...
                <ScrollReveal direction="left" delay={200}>
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      ...
                      projects, or hiking in the mountains. I believe in continuous learning and pushing the boundaries
          ...
          <section id="projects" className="min-h-screen bg-black py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <section
            id="contact"
            className="min-h-screen bg-gray-950 py-20 px-4 sm:px-6 lg:px-8 flex items-center relative overflow-hidden"
          >
            {/* Parallax background */}
          ...
          <footer className="bg-black py-8 px-4 border-t border-gray-800 relative overflow-hidden">
